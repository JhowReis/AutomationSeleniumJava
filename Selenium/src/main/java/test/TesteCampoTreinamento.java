...
public class TesteCampoTreinamento {
	...
	public void testTextFieldDuplo(){
		dsl.escrever("elementosForm:nome", "Jonathan");
		Assert.assertEquals("Jonathan", dsl.obterValorCampo("elementosForm:nome"));
		dsl.escrever("elementosForm:nome", "Reis");
		Assert.assertEquals("Reis", dsl.obterValorCampo("elementosForm:nome"));
	}
